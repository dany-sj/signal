...
local function run(msg, matches)
  if matches[1]:lower() == 'telekings' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /telekings ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "telekings" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (telekings)",-- Put everything you like :)
		"^[!/]([Tt]elekings)"-- Put everything you like :)
    }, 
  run = run
}
